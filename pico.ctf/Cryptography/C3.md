# What I did
So this one was very challenging for me. I haven't finished this chall but I feel like I have grasped the basic concept. I have to learn about inverse modulo. 
...
```
To reverse the code, I came up with this:
```
lookup1 = "\n \"#()*+/1:=[]abcdefghijklmnopqrstuvwxyz"
lookup2 = "ABCDEFGHIJKLMNOPQRSTabcdefghijklmnopqrst"
